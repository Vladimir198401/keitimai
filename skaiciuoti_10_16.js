		function skaiciuoti_10_16() {
			...
			while ( dvl > 0 ) {	// kol  dal yra daugiau uz 0 , ciklo funkcijos vigdomos pagal nuroditus parametrus, kai nebe , funkcija  while cikle nebevikdoma
								//ciklas ("kilpa, ratu besikartojantis"), kartojantis koda, kelis kartus ji atkartoja iki nustatitos rybos
			
				skaitmuo = parseInt (dvl /16);   // skaitmuo - funkcija kuriai pries for cikla buvo suteikta reiksme ligi 0, jai suteikiama reiksme naudojama is  kitu funkciju parseInt ( ...... ) 
				...
				skaitmuo_sk = (dvl %16);     // padalinus dvl eilute i 16 perkeliama liekana likuse po 16
